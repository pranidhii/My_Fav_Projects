...
df = read_excel("RemovedDeathsForRecoveryRate.xlsx")
colnames(df)
head(df)
...
plot(survfit(data ~ df$gender12),xlab = "Days",ylab = "Overall survival probability") #- survival curve calculation
ggsurvplot(survfit(data ~ df$gender12),data = df)
